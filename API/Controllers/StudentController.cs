...
namespace API.Controllers
{
    ...
    public class StudentController : ControllerBase
    {
        ...
        [HttpPut("updateprezime")]
        public async Task<ActionResult> UpdatePezime(int id, string prezime)
        {
            try
            {
                await _repo.UpdatePrezime(id, prezime);
                return Ok("Uspesno izmenjeno prezime");
            }
            catch (Exception ex)
            {
                return BadRequest(ex.Message);
